...
public class Wiki implements Serializable
{
	...
	*/
	...
	//private String useragent = "Wiki.java " + version + "(https://github.com/MER-C/wiki-java/)";	//old form wiki
	private String useragent = "Wiki.java " + version + " MERA";
	...
	*/
	public synchronized void login(String username, char[] password) throws IOException, FailedLoginException
	{
		...
		/**
		 * ADDED:
		 * domain is MERA for MERA users
		 * TODO: MERA
		 */
		buffer.append("&lgdomain=MERA");
	...
	* @since 0.17
	*/
	public synchronized void edit(String title, String text, String summary, boolean minor, boolean bot, int section, Calendar basetime)
	...
	* @since 0.30
	*/
	public Revision[] deletedContribs(String u, Calendar end, Calendar start, boolean reverse, int... namespace) throws IOException,
	...
	* @since 0.16
	*/
	public synchronized void move(String title, String newTitle, String reason, boolean noredirect, boolean movetalk, boolean movesubpages)
			throws IOException, LoginException
	{
		long start = System.currentTimeMillis();
		// check for log in
	...
	*/
	public Map<String, Object> getFileMetadata(String file) throws IOException
	{
		...
		String url = query + "prop=imageinfo&iiprop=size%7Cmime%7Cmetadata&titles=" + URLEncoder.encode(normalize("File:" + file), "UTF-8");
	...
	* @since 0.08
	*/
	public LogEntry[] getLogEntries(Calendar start, Calendar end, int amount, String log, String action, User user, String target, int namespace)
			throws IOException
	{
	...
	* @throws IOException if a network error occurs
	*/
	public String[] listPages(String prefix, Map<String, Object> protectionstate, int namespace, int minimum, int maximum, Boolean redirects)
			throws IOException
	{
	...
	*/
	protected String fetch(String url, String caller) throws IOException
	{
		...
		// get the text
		String temp;
		try (BufferedReader in = new BufferedReader(new InputStreamReader(zipped ? new GZIPInputStream(connection.getInputStream())
